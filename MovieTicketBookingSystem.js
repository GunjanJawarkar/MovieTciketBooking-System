...
function addMovie(){
    console.log("\n\n********************** Add a Movie *********************");
    var movienumber = require('readline-sync').question("Enter Movie Number: ");
    ...
    connection.query('INSERT INTO movie SET ?', movie, function(err, result) {
       // if (err) throw err;
        ...
        data.push([movie.movieNumber, movie.movieName, movie.movieTime, movie.movieDate, movie.movieSeats, movie.moviePrice]);
